...
const labsData = [
  ...
  },
  {
    ...
    xp: 300,
    status: "not-started",
    desc: "Perform ARP spoofing attacks to intercept network communications.",
    objectives: [
      "Set up ARP spoofing environment",
  ...
  },
  {
    ...
    xp: 200,
    status: "not-started",
    desc: "Exploit path traversal vulnerabilities to read arbitrary files from the server.",
    objectives: [
  ...
  },
  {
    ...
    xp: 350,
    status: "not-started",
    desc: "Exploit XXE vulnerabilities to read internal files and perform SSRF attacks.",
    objectives: [
  ...
  },
  {
    ...
    xp: 200,
    status: "not-started",
    desc: "Exploit weak authentication mechanisms including session fixation and token prediction.",
    objectives: [
  ...
  },
  {
    ...
    xp: 400,
    status: "not-started",
    desc: "Exploit stack-based buffer overflows to gain code execution on a vulnerable binary.",
    objectives: [
  ...
  {
    id: 15,
    title: "JWT Attacks Lab",
    category: "Web Exploitation",
    difficulty: "Intermediate",
    diffColor: "bg-blue-600",
    xp: 250,
    status: "not-started",
    desc: "Exploit common JWT vulnerabilities including algorithm confusion and key injection.",
    objectives: [
      "Understand JWT structure",
      "Exploit alg:none attack",
  ...
  },
  {
    ...
    xp: 350,
    status: "not-started",
    desc: "Perform SSRF attacks to access internal services and cloud metadata endpoints.",
    objectives: [
      "Understand SSRF mechanics",
      "Bypass SSRF filters",
  ...
  },
  {
    ...
    xp: 250,
    status: "not-started",
    desc: "Extract hidden messages from images and audio files using steganography tools.",
    objectives: [
      "Understand steganography basics",
      "Use steghide and binwalk",
      "Extract hidden data from images",
      "Solve steganography CTF challenges",
    ],
  },
  {
    id: 18,
    ...
    xp: 400,
    status: "not-started",
    desc: "Escalate privileges on a Linux system using SUID binaries and sudo misconfigurations.",
    objectives: [
      "Enumerate system for privesc vectors",
      "Exploit SUID binaries",
      "Abuse sudo misconfiguration",
      "Use kernel exploits",
    ],
  },
  {
    ...
    xp: 450,
    status: "not-started",
    desc: "Perform Kerberoasting, Pass-the-Hash, and DCSync attacks against Active Directory.",
    objectives: [
  ...
  {
    id: 20,
    title: "Wi-Fi Hacking Lab",
    category: "Network",
    difficulty: "Advanced",
    diffColor: "bg-orange-500",
    xp: 400,
    status: "not-started",
    desc: "Crack WPA2 passwords and perform Evil Twin attacks against wireless networks.",
    objectives: [
      "Set up wireless attack environment",
  ...
  },
  {
    ...
    xp: 450,
    status: "not-started",
    desc: "Reverse engineer compiled binaries to find hidden flags and understand program logic.",
    objectives: [
...
const categories = ["All", "SQL Injection", "XSS", "CSRF", "Command Injection", "Cryptography", "Network", "Web Exploitation", "Binary Exploitation", "Linux Security"];
